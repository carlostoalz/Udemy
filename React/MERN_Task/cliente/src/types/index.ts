// Proyectos
export const FORMULARIO_PROYECTO:string = "FORMULARIO_PROYECTO";
export const OBTENER_PROYECTOS:string = "OBTENER_PROYECTOS";
export const AGREGAR_PROYECTO:string = "AGREGAR_PROYECTO";
...
// Auth
export const REGISTRO_EXITOSO:string = "REGISTRO_EXITOSO";
export const REGISTRO_ERROR:string = "REGISTRO_ERROR";
export const OBTENER_USUARIO:string = "OBTENER_USUARIO";
export const LOGIN_EXITOSO:string = "LOGIN_EXITOSO";
